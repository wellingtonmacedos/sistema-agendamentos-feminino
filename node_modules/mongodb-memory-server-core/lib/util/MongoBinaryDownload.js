...
class MongoBinaryDownload {
    ...
    async httpDownload(url, httpOptions, downloadLocation, tempDownloadLocation, maxRetries, baseDelay = 1000, timeout = 60000) {
        ...
        for (let attempt = 1; attempt <= retries; attempt++) {
            try {
                return await this.attemptDownload(url, useHttpsOptions, downloadLocation, tempDownloadLocation, downloadUrl, timeout);
            }
            catch (error) {
     ...
     * @private
     */
    async attemptDownload(url, useHttpsOptions, downloadLocation, tempDownloadLocation, downloadUrl, timeout = 60000) {
        /** Offset to resume from; for now a non-0 value indicates to use file "append" mode */
        let offset = 0;
        if ((0, resolveConfig_1.envToBool)((0, resolveConfig_1.default)(resolveConfig_1.ResolveConfigVariables.RESUME_DOWNLOAD))) {
